...
app.put('/favorite', async (req, res) => {
  ...
  // console.log(drugToChange.favorite);
  // console.log(drugToChange);
  // console.log(typeof drugToChange['favorite']);
  // console.log(drugToChange.dataValues.favorite);
  // console.log(drugToChange.available_qty);
  // console.log(drugToChange.isNewRecord);
})
